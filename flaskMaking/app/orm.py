...
class Analysis(db.Model):
    ...
    #HAD TO TAKE THIS OUT AS IT WAS HAVING ISSUES WITH PLAYERS WITH DATA MOSTLY CONSISTING OF 0'S (throws error on 0/0 basically) FIXED: added update to manually calculate rc27
